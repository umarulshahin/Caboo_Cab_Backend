            ...
            if 'userRequest' in data and 'type' in data['userRequest']:
                ...
                if user_type == 'user':
                    ...
                    await self.channel_layer.group_send(
                            ...
                            {
                                'type': 'SuccessNotification',
                                'status': 'User is already active as a driver',
                                'message': "The user is already active as a driver. Please change the driver status first.",
                            }
                        )
                    
                    print(f"Ride request received from a User (ID: {user_id}). Ignoring.")
